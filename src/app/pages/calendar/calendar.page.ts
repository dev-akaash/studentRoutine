...
export class CalendarPage implements OnInit {
  ...
  getCurrentMonth(): Day[] {
    return this.getMonth(this.currentMonthIndex, this.currentYear, this.todayDate);
  }

  getMonth(monthIndex: number, year: number, day: number): Day[] {
    let days = [];
    let today = day;
  ...
  onNextMonth() {
    ...
    this.setMonthDays(this.getMonth(this.monthNumber, this.year, this.todayDate));
  }
